function add_std_validation(event) {
    ...
    if(!con) {
        document.getElementById('crs_massage').innerHTML = "**Please Choose At Least One Course";
        return false;   
    }
    ...
    for (e = 0; e < courses.length; e++) {
        for (s = 0; s < courses[e].students.length; s++) {

            if (phone == courses[e].students[s].phone) {
                document.getElementById('phone_massage').innerHTML = "**The Phone You Entered Is Already Exists!";
                return false;
            }

            if (email == courses[e].students[s].mail) {
...
function edit_std_validation(event) {
    event.preventDefault();
    ...
    for (e = 0; e < courses.length; e++) {
        for (s = 0; s < courses[e].students.length; s++) {
            if (phone == courses[e].students[s].phone && id != courses[e].students[s].id) {
                document.getElementById('phone_massage').innerHTML = "**The Phone You Entered Is Already Exists!";
                return false;
            }

            if (email == courses[e].students[s].mail && id != courses[e].students[s].id) {
                document.getElementById('email_massage').innerHTML = "**The Email You Entered Is Already Exists!";
                return false;
            }
        }
